...
class graph_base {
 ...
 public:
  ...
  void generate_weight_constant(float const_weight) {
    weight = new weight_t[edge_count];
    std::fill(weight, weight + edge_count, const_weight);
  }
  ...
  graph_base(const char* xadj_file, const char* adjncy_file, const char* weight_file) {
    load_graph(xadj_file, adjncy_file, weight_file);
  }
